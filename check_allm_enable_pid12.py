...
def export_report(res1: Dict[str, object], res2: Dict[str, object], xlsx_path: str, sheet_name: str = "ALLM") -> None:
    ...
    rules = (
        "5. ALLM 要打開\n" \
        "  5.1 Model.ini 要把 isSupportALLM = true.\n" \
        "  5.2 TvDefaultSettingsPath 可以決定要不要開 ALLM\n" \
        "  5.3 到 TvDefaultSettingsPath 裡去將各路 source 的 ALLM 打開"
    )
