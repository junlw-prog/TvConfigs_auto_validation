...
def export_simple_report(res: Dict[str, object], xlsx_path: str, sheet_name: str = "Setupwizard") -> None:
    ...
    # Row content
    rules = "model.ini → isShowSetupwizard must be true"
...
def main():
    ...
    if args.report_xlsx:
        ...
        print(f"[INFO] Report appended to: {args.report_xlsx} (sheet: Setupwizard)")
    elif args.report:
        export_simple_report(res, "kipling.xlsx")
        print(f"[INFO] Report appended to: kipling.xlsx (sheet: Setupwizard)")
